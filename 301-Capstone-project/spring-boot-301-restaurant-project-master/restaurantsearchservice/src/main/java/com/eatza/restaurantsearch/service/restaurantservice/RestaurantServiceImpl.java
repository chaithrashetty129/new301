...
public class RestaurantServiceImpl implements RestaurantService {
	...
	public RestaurantResponseDto findAllRestaurants(int pageNumber, int pageSize) {
		...
		logger.debug("In find all restaurants, creating pageable" + " object for page Number:" + pageNumber
	...
	@KafkaListener(topics = "ReviewKafka", groupId = "group_json", containerFactory = "reviewKafkaListenerFactory")
	public void consumeJson(ReviewDto reviewDto) {
		System.out.println("Consumed JSON Message: " + reviewDto);
		Restaurant restaurant=restaurantRepository.findById(reviewDto.getRestaurantId()).get();
	    restaurant.setRating(reviewDto.getRating());
	...
	public RestaurantResponseDto findByName(String name, int pageNumber, int pageSize) {
		logger.debug("In findByName, creating pageable" + " object for page Number:" + pageNumber + " and page size: "
				+ pageSize);
		Pageable pageable = PageRequest.of(pageNumber - 1, pageSize);
	...
	public RestaurantResponseDto findByLocationAndCuisine(String location, String cuisine, int pageNumber,
			int pageSize) {
		logger.debug("In findByLocationAndCuisine, creating pageable" + " object for page Number:" + pageNumber
				+ " and page size: " + pageSize);
		Pageable pageable = PageRequest.of(pageNumber - 1, pageSize);
	...
	public RestaurantResponseDto findByLocationAndName(String location, String name, int pageNumber, int pageSize) {
		logger.debug("In findByLocationAndName, creating pageable" + " object for page Number:" + pageNumber
				+ " and page size: " + pageSize);
		Pageable pageable = PageRequest.of(pageNumber - 1, pageSize);
	...
	public RestaurantResponseDto findByBudget(int budget, int pageNumber, int pageSize) {
		logger.debug("In findByBudget, creating pageable" + " object for page Number:" + pageNumber + " and page size: "
				+ pageSize);
		Pageable pageable = PageRequest.of(pageNumber - 1, pageSize);
	...
	public RestaurantResponseDto findByRating(double rating, int pageNumber, int pageSize) {
		logger.debug("In findByRating, creating pageable" + " object for page Number:" + pageNumber + " and page size: "
				+ pageSize);
		Pageable pageable = PageRequest.of(pageNumber - 1, pageSize);
